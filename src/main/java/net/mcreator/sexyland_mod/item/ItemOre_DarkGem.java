...
public class ItemOre_DarkGem extends ElementsSexyland.ModElement {
	@GameRegistry.ObjectHolder("sexyland_mod:ore_darkgem")
	public static final Item block = null;
	public ItemOre_DarkGem(ElementsSexyland instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("sexyland_mod:ore_darkgem", "inventory"));
	}
